...
mod test {
    ...
    #[test]
    fn crank_phase_reaches_2_pi_after_1_second() {
    ...
    #[test]
    fn crank_phase_increases_the_phase_for_one_sample() {
        let mut generator = generator();
    ...
    #[test]
    fn crank_phase_wraps_around_at_2_pi() {
        let mut generator = generator();
    ...
    #[test]
    fn it_works_for_different_frequencies() {
        let mut generator = generator();
        let buffer: &mut [f32] = &mut [42.0; 10];
    ...
    #[test]
    fn it_allows_to_change_the_frequency_later() {
        let mut generator = generator();
        let buffer: &mut [f32] = &mut [42.0; 10];
        generator.frequency = 300.0;
        generator.generate(SAMPLE_RATE, buffer);
